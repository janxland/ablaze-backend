CREATE DATABASE IF NOT EXISTS poetry DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
INSERT INTO `poetry`.`user`(`id`, `username`, `password`, `phone_number`, `email`, `user_status`, `gender`, `open_id`, `avatar`, `introduction`, `user_type`, `update_by`, `deleted`) VALUES (1, 'Sara', '', '', '', 1, 1, '', '', '', 0, 'Sara', 0);
